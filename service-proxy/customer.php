<?php
    ...
    class Customer{
        ...
        function setUpdateBy($updateBy) { $this->updateBy = $updateBy; }
        function getUpdateBy() { return $this->updateBy; }
        function setUpdateOn($updateOn) { $this->updateOn = $updateOn; }
        function getUpdateOn() { return $this->updateOn; }
        ...
        public function insert(){
            $sql = 'INSERT INTO ' . $this->tableName . '(id, name, email, address, mobile,
            created_by, created_on) VALUES(null, :name, :email, :address, :mobile,
        ...
        public function update() {
            ...
            $stmt->bindParam(":updatedBy", $this->updateBy);
            $stmt->bindParam(":updatedOn", $this->updateOn);
